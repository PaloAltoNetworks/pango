...
func getTests() []tc {
	return []tc{
		...
		{"v2 with credential enforcement settings mode disabled", version.Number{8, 0, 0, ""}, Entry{
			...
			Description:        "foobar",
			BlockListAction:    "alert",
			CesMode:            CesModeDisabled,
			CesAllowCategories: []string{"hacking", "dating", "malware", "phishing"},
		}},
		{"v2 with credential enforcement settings mode user ip user mappings", version.Number{8, 0, 0, ""}, Entry{
			Name:               "t1",
			Description:        "foobar",
			BlockListAction:    "alert",
			CesMode:            CesModeIpUser,
			CesLogSeverity:     "informational",
			CesAlertCategories: []string{"hacking", "dating", "malware", "phishing"},
		}},
		{"v2 with credential enforcement settings mode domain credentials", version.Number{8, 0, 0, ""}, Entry{
			Name:               "t1",
			Description:        "foobar",
			BlockListAction:    "alert",
			CesMode:            CesModeDomainCredentials,
			CesLogSeverity:     "informational",
			CesBlockCategories: []string{"hacking", "dating", "malware", "phishing"},
		}},
		{"v2 with credential enforcement settings mode group mapping", version.Number{8, 0, 0, ""}, Entry{
			Name:                  "t1",
			Description:           "foobar",
			BlockListAction:       "alert",
			CesMode:               CesModeGroupMapping,
			CesModeGroupMapping:   "myGroup",
			CesLogSeverity:        "informational",
			CesContinueCategories: []string{"hacking", "dating", "malware", "phishing"},
		}},
