...
func TestFwNormalization(t *testing.T) {
    testCases := []struct{
        ...
        {"test5", version.Number{6, 1, 0, ""}, Entry{
            Name: "test5",
            Version: Ikev1,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.3.4.5",
        ...
        {"test13", version.Number{7, 0, 0, ""}, Entry{
            Name: "test13",
        ...
        {"test14", version.Number{7, 0, 0, ""}, Entry{
            Name: "test14",
            Version: Ikev2Preferred,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.3.4.5",
        ...
        {"test15", version.Number{8, 1, 0, ""}, Entry{
            Name: "test15",
            Version: Ikev1,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.1.1.1",
        ...
        {"test16", version.Number{8, 1, 0, ""}, Entry{
            Name: "test16",
            Version: Ikev1,
            PeerIpType: PeerTypeDynamic,
            Interface: "tunnel.2",
        ...
        {"test17", version.Number{8, 1, 0, ""}, Entry{
            Name: "test17",
            Version: Ikev1,
            PeerIpType: PeerTypeDynamic,
            Interface: "tunnel.3",
        ...
        {"test18", version.Number{8, 1, 0, ""}, Entry{
            Name: "test18",
            Version: Ikev1,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.3.4.5",
        ...
        {"test19", version.Number{8, 1, 0, ""}, Entry{
            Name: "test19",
            Version: Ikev2,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.3.4.5",
        ...
        {"test20", version.Number{8, 1, 0, ""}, Entry{
            Name: "test20",
            Version: Ikev2,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.3.4.5",
        ...
        {"test21", version.Number{8, 1, 0, ""}, Entry{
            Name: "test21",
            Version: Ikev2,
            PeerIpType: PeerTypeIp,
            PeerIpValue: "10.3.4.5",
