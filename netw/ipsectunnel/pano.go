...
func (c *PanoIpsecTunnel) GetList(tmpl string) ([]string, error) {
...
func (c *PanoIpsecTunnel) ShowList(tmpl string) ([]string, error) {
...
// profile.
func (c *PanoIpsecTunnel) Get(tmpl, name string) (Entry, error) {
...
// profile.
func (c *PanoIpsecTunnel) Show(tmpl, name string) (Entry, error) {
...
func (c *PanoIpsecTunnel) Set(tmpl string, e ...Entry) error {
    var err error
...
func (c *PanoIpsecTunnel) Edit(tmpl string, e Entry) error {
    var err error
...
func (c *PanoIpsecTunnel) Delete(tmpl string, e ...interface{}) error {
    var err error
...
func (c *PanoIpsecTunnel) details(fn util.Retriever, tmpl, name string) (Entry, error) {
...
func (c *PanoIpsecTunnel) xpath(tmpl string, vals []string) []string {
