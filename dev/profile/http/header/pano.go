...
func (c *PanoHeader) ShowList(tmpl, ts, vsys, profile, logtype string) ([]string, error) {
...
func (c *PanoHeader) GetList(tmpl, ts, vsys, profile, logtype string) ([]string, error) {
...
func (c *PanoHeader) Get(tmpl, ts, vsys, profile, logtype, name string) (Entry, error) {
	c.con.LogQuery("(get) %s %q", singular, name)
	return c.details(c.con.Get, tmpl, ts, vsys, profile, logtype, name)
}

// Show performs SHOW to retrieve information for the given uid.
func (c *PanoHeader) Show(tmpl, ts, vsys, profile, logtype, name string) (Entry, error) {
	c.con.LogQuery("(show) %s %q", singular, name)
	return c.details(c.con.Show, tmpl, ts, vsys, profile, logtype, name)
}

// Set performs SET to create / update one or more objects.
func (c *PanoHeader) Set(tmpl, ts, vsys, profile, logtype string, e ...Entry) error {
	var err error
...
func (c *PanoHeader) Edit(tmpl, ts, vsys, profile, logtype string, e Entry) error {
	var err error
...
func (c *PanoHeader) Delete(tmpl, ts, vsys, profile, logtype string, e ...interface{}) error {
	var err error
...
func (c *PanoHeader) details(fn util.Retriever, tmpl, ts, vsys, profile, logtype, name string) (Entry, error) {
...
func (c *PanoHeader) xpath(tmpl, ts, vsys, profile, logtype string, vals []string) []string {
	var ans []string
