...
var (
	_ Matcher = &GreaterThanOrEqualTo{}
)
...
func (o *GreaterThanOrEqualTo) Matches(f Fielder) (bool, error) {
...
func (o *GreaterThanOrEqualTo) GetOperator() *Operator { return o.Operator }
