...
var (
	suffix = []string{"log-settings", "email", "$name"}
)
...
type serverXml struct {
	...
	AndAlsoTo          *string       `xml:"and-also-to,omitempty"`
...
func (o *Server) matches(other *Server) bool {
	...
	if !util.StringsMatch(o.DisplayName, other.DisplayName) {
		return false
	}
	if !util.StringsMatch(o.From, other.From) {
		return false
	}
	if !util.StringsMatch(o.To, other.To) {
		return false
	}
	if !util.StringsMatch(o.AndAlsoTo, other.AndAlsoTo) {
		return false
	}
	...
	if !util.StringsMatch(o.TlsVersion, other.TlsVersion) {
		return false
	}
	if !util.StringsMatch(o.Auth, other.Auth) {
		return false
