...
var (
	Suffix = []string{"network", "interface", "ethernet", "$parent", "layer3", "units", "$name"}
)
...
type Pppoe struct {
	...
	DefaultRouteMetric *int64
	Enable             *bool
	Passive            *PppoePassive
	Password           *string
	Service            *string
	StaticAddress      *PppoeStaticAddress
	Username           *string
}
...
type entryXml struct {
	...
	Pppoe                      *PppoeXml             `xml:"pppoe,omitempty"`
...
type PppoeXml struct {
	AccessConcentrator *string                `xml:"access-concentrator,omitempty"`
	Authentication     *string                `xml:"authentication,omitempty"`
	CreateDefaultRoute *string                `xml:"create-default-route,omitempty"`
	DefaultRouteMetric *int64                 `xml:"default-route-metric,omitempty"`
	Enable             *string                `xml:"enable,omitempty"`
	Passive            *PppoePassiveXml       `xml:"passive,omitempty"`
	Password           *string                `xml:"password,omitempty"`
	Service            *string                `xml:"service,omitempty"`
	StaticAddress      *PppoeStaticAddressXml `xml:"static-address,omitempty"`
	Username           *string                `xml:"username,omitempty"`

	Misc []generic.Xml `xml:",any"`
}
type PppoePassiveXml struct {
	Enable *string `xml:"enable,omitempty"`

	Misc []generic.Xml `xml:",any"`
}
type PppoeStaticAddressXml struct {
...
func specifyEntry(o *Entry) (any, error) {
	...
	entry.DecryptForward = util.YesNo(o.DecryptForward, nil)
	...
	if o.Ip != nil {
		...
		for _, oIp := range o.Ip {
			...
			if oIp.SdwanGateway != nil {
				nestedIp.SdwanGateway = oIp.SdwanGateway
			}
			if oIp.Name != "" {
	...
	var nestedPppoe *PppoeXml
	if o.Pppoe != nil {
		nestedPppoe = &PppoeXml{}
		if _, ok := o.Misc["Pppoe"]; ok {
			nestedPppoe.Misc = o.Misc["Pppoe"]
		}
		if o.Pppoe.CreateDefaultRoute != nil {
			nestedPppoe.CreateDefaultRoute = util.YesNo(o.Pppoe.CreateDefaultRoute, nil)
		}
		if o.Pppoe.DefaultRouteMetric != nil {
			nestedPppoe.DefaultRouteMetric = o.Pppoe.DefaultRouteMetric
		}
		if o.Pppoe.Enable != nil {
			nestedPppoe.Enable = util.YesNo(o.Pppoe.Enable, nil)
		}
		if o.Pppoe.Passive != nil {
			nestedPppoe.Passive = &PppoePassiveXml{}
			if _, ok := o.Misc["PppoePassive"]; ok {
				nestedPppoe.Passive.Misc = o.Misc["PppoePassive"]
			}
			if o.Pppoe.Passive.Enable != nil {
				nestedPppoe.Passive.Enable = util.YesNo(o.Pppoe.Passive.Enable, nil)
			}
		}
		if o.Pppoe.Password != nil {
			nestedPppoe.Password = o.Pppoe.Password
		}
		if o.Pppoe.AccessConcentrator != nil {
			nestedPppoe.AccessConcentrator = o.Pppoe.AccessConcentrator
		}
		if o.Pppoe.Authentication != nil {
			nestedPppoe.Authentication = o.Pppoe.Authentication
		}
		if o.Pppoe.Username != nil {
			nestedPppoe.Username = o.Pppoe.Username
		}
		if o.Pppoe.Service != nil {
			nestedPppoe.Service = o.Pppoe.Service
		}
		if o.Pppoe.StaticAddress != nil {
			nestedPppoe.StaticAddress = &PppoeStaticAddressXml{}
			if _, ok := o.Misc["PppoeStaticAddress"]; ok {
				nestedPppoe.StaticAddress.Misc = o.Misc["PppoeStaticAddress"]
			}
			if o.Pppoe.StaticAddress.Ip != nil {
				nestedPppoe.StaticAddress.Ip = o.Pppoe.StaticAddress.Ip
			}
		}
	}
	entry.Pppoe = nestedPppoe

	var nestedSdwanLinkSettings *SdwanLinkSettingsXml
	if o.SdwanLinkSettings != nil {
		nestedSdwanLinkSettings = &SdwanLinkSettingsXml{}
		if _, ok := o.Misc["SdwanLinkSettings"]; ok {
			nestedSdwanLinkSettings.Misc = o.Misc["SdwanLinkSettings"]
		}
		if o.SdwanLinkSettings.Enable != nil {
			nestedSdwanLinkSettings.Enable = util.YesNo(o.SdwanLinkSettings.Enable, nil)
		}
		if o.SdwanLinkSettings.SdwanInterfaceProfile != nil {
			nestedSdwanLinkSettings.SdwanInterfaceProfile = o.SdwanLinkSettings.SdwanInterfaceProfile
		}
		if o.SdwanLinkSettings.UpstreamNat != nil {
			nestedSdwanLinkSettings.UpstreamNat = &SdwanLinkSettingsUpstreamNatXml{}
			if _, ok := o.Misc["SdwanLinkSettingsUpstreamNat"]; ok {
				nestedSdwanLinkSettings.UpstreamNat.Misc = o.Misc["SdwanLinkSettingsUpstreamNat"]
			}
			if o.SdwanLinkSettings.UpstreamNat.Enable != nil {
				nestedSdwanLinkSettings.UpstreamNat.Enable = util.YesNo(o.SdwanLinkSettings.UpstreamNat.Enable, nil)
			}
			if o.SdwanLinkSettings.UpstreamNat.Ddns != nil {
				nestedSdwanLinkSettings.UpstreamNat.Ddns = &SdwanLinkSettingsUpstreamNatDdnsXml{}
				if _, ok := o.Misc["SdwanLinkSettingsUpstreamNatDdns"]; ok {
					nestedSdwanLinkSettings.UpstreamNat.Ddns.Misc = o.Misc["SdwanLinkSettingsUpstreamNatDdns"]
				}
			}
			if o.SdwanLinkSettings.UpstreamNat.StaticIp != nil {
				nestedSdwanLinkSettings.UpstreamNat.StaticIp = &SdwanLinkSettingsUpstreamNatStaticIpXml{}
				if _, ok := o.Misc["SdwanLinkSettingsUpstreamNatStaticIp"]; ok {
					nestedSdwanLinkSettings.UpstreamNat.StaticIp.Misc = o.Misc["SdwanLinkSettingsUpstreamNatStaticIp"]
				}
				if o.SdwanLinkSettings.UpstreamNat.StaticIp.Fqdn != nil {
					nestedSdwanLinkSettings.UpstreamNat.StaticIp.Fqdn = o.SdwanLinkSettings.UpstreamNat.StaticIp.Fqdn
				}
				if o.SdwanLinkSettings.UpstreamNat.StaticIp.IpAddress != nil {
					nestedSdwanLinkSettings.UpstreamNat.StaticIp.IpAddress = o.SdwanLinkSettings.UpstreamNat.StaticIp.IpAddress
				}
			}
		}
	}
	entry.SdwanLinkSettings = nestedSdwanLinkSettings
...
func (c *entryXmlContainer) Normalize() ([]*Entry, error) {
	...
	for _, o := range c.Answer {
		...
		entry.DecryptForward = util.AsBool(o.DecryptForward, nil)
		...
		entry.NetflowProfile = o.NetflowProfile
		var nestedPppoe *Pppoe
		if o.Pppoe != nil {
			nestedPppoe = &Pppoe{}
			if o.Pppoe.Misc != nil {
				entry.Misc["Pppoe"] = o.Pppoe.Misc
			}
			if o.Pppoe.Service != nil {
				nestedPppoe.Service = o.Pppoe.Service
			}
			if o.Pppoe.StaticAddress != nil {
				nestedPppoe.StaticAddress = &PppoeStaticAddress{}
				if o.Pppoe.StaticAddress.Misc != nil {
					entry.Misc["PppoeStaticAddress"] = o.Pppoe.StaticAddress.Misc
				}
				if o.Pppoe.StaticAddress.Ip != nil {
					nestedPppoe.StaticAddress.Ip = o.Pppoe.StaticAddress.Ip
				}
			...
			if o.Pppoe.Enable != nil {
				nestedPppoe.Enable = util.AsBool(o.Pppoe.Enable, nil)
			}
			if o.Pppoe.Passive != nil {
				nestedPppoe.Passive = &PppoePassive{}
				if o.Pppoe.Passive.Misc != nil {
					entry.Misc["PppoePassive"] = o.Pppoe.Passive.Misc
				}
				if o.Pppoe.Passive.Enable != nil {
					nestedPppoe.Passive.Enable = util.AsBool(o.Pppoe.Passive.Enable, nil)
				}
			}
			if o.Pppoe.Password != nil {
				nestedPppoe.Password = o.Pppoe.Password
			...
			if o.Pppoe.CreateDefaultRoute != nil {
				nestedPppoe.CreateDefaultRoute = util.AsBool(o.Pppoe.CreateDefaultRoute, nil)
			}
			if o.Pppoe.DefaultRouteMetric != nil {
				nestedPppoe.DefaultRouteMetric = o.Pppoe.DefaultRouteMetric
			}
		...
		var nestedSdwanLinkSettings *SdwanLinkSettings
		if o.SdwanLinkSettings != nil {
			nestedSdwanLinkSettings = &SdwanLinkSettings{}
			if o.SdwanLinkSettings.Misc != nil {
				entry.Misc["SdwanLinkSettings"] = o.SdwanLinkSettings.Misc
			}
			if o.SdwanLinkSettings.Enable != nil {
				nestedSdwanLinkSettings.Enable = util.AsBool(o.SdwanLinkSettings.Enable, nil)
			}
			if o.SdwanLinkSettings.SdwanInterfaceProfile != nil {
				nestedSdwanLinkSettings.SdwanInterfaceProfile = o.SdwanLinkSettings.SdwanInterfaceProfile
			}
			if o.SdwanLinkSettings.UpstreamNat != nil {
				nestedSdwanLinkSettings.UpstreamNat = &SdwanLinkSettingsUpstreamNat{}
				if o.SdwanLinkSettings.UpstreamNat.Misc != nil {
					entry.Misc["SdwanLinkSettingsUpstreamNat"] = o.SdwanLinkSettings.UpstreamNat.Misc
				}
				if o.SdwanLinkSettings.UpstreamNat.Enable != nil {
					nestedSdwanLinkSettings.UpstreamNat.Enable = util.AsBool(o.SdwanLinkSettings.UpstreamNat.Enable, nil)
				}
				if o.SdwanLinkSettings.UpstreamNat.Ddns != nil {
					nestedSdwanLinkSettings.UpstreamNat.Ddns = &SdwanLinkSettingsUpstreamNatDdns{}
					if o.SdwanLinkSettings.UpstreamNat.Ddns.Misc != nil {
						entry.Misc["SdwanLinkSettingsUpstreamNatDdns"] = o.SdwanLinkSettings.UpstreamNat.Ddns.Misc
					}
				}
				if o.SdwanLinkSettings.UpstreamNat.StaticIp != nil {
					nestedSdwanLinkSettings.UpstreamNat.StaticIp = &SdwanLinkSettingsUpstreamNatStaticIp{}
					if o.SdwanLinkSettings.UpstreamNat.StaticIp.Misc != nil {
						entry.Misc["SdwanLinkSettingsUpstreamNatStaticIp"] = o.SdwanLinkSettings.UpstreamNat.StaticIp.Misc
					}
					if o.SdwanLinkSettings.UpstreamNat.StaticIp.Fqdn != nil {
						nestedSdwanLinkSettings.UpstreamNat.StaticIp.Fqdn = o.SdwanLinkSettings.UpstreamNat.StaticIp.Fqdn
					}
...
func SpecMatches(a, b *Entry) bool {
	...
	if !matchPppoe(a.Pppoe, b.Pppoe) {
		return false
	}
	if !matchSdwanLinkSettings(a.SdwanLinkSettings, b.SdwanLinkSettings) {
		return false
	}
	if !util.Ints64Match(a.Tag, b.Tag) {
		return false
	}
...
func matchSdwanLinkSettingsUpstreamNatDdns(a *SdwanLinkSettingsUpstreamNatDdns, b *SdwanLinkSettingsUpstreamNatDdns) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
...
func matchSdwanLinkSettingsUpstreamNatStaticIp(a *SdwanLinkSettingsUpstreamNatStaticIp, b *SdwanLinkSettingsUpstreamNatStaticIp) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
...
func matchSdwanLinkSettingsUpstreamNat(a *SdwanLinkSettingsUpstreamNat, b *SdwanLinkSettingsUpstreamNat) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
	...
	if !matchSdwanLinkSettingsUpstreamNatStaticIp(a.StaticIp, b.StaticIp) {
		return false
	}
	if !matchSdwanLinkSettingsUpstreamNatDdns(a.Ddns, b.Ddns) {
		return false
	}
	return true
}
func matchSdwanLinkSettings(a *SdwanLinkSettings, b *SdwanLinkSettings) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
	}
	if !matchSdwanLinkSettingsUpstreamNat(a.UpstreamNat, b.UpstreamNat) {
		return false
	}
	if !util.BoolsMatch(a.Enable, b.Enable) {
		return false
...
func matchPppoeStaticAddress(a *PppoeStaticAddress, b *PppoeStaticAddress) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
...
func matchPppoePassive(a *PppoePassive, b *PppoePassive) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
...
func matchPppoe(a *Pppoe, b *Pppoe) bool {
	if a == nil && b != nil || a != nil && b == nil {
		return false
	} else if a == nil && b == nil {
		return true
	...
	if !matchPppoeStaticAddress(a.StaticAddress, b.StaticAddress) {
		return false
	}
	...
	if !matchPppoePassive(a.Passive, b.Passive) {
		return false
	}
