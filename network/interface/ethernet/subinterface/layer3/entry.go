...
type entryXml_11_0_2 struct {
	...
	NetflowProfile             *string                      `xml:"netflow-profile,omitempty"`
	Pppoe                      *pppoeXml_11_0_2             `xml:"pppoe,omitempty"`
...
type pppoeXml_11_0_2 struct {
	AccessConcentrator *string                       `xml:"access-concentrator,omitempty"`
	Authentication     *string                       `xml:"authentication,omitempty"`
	CreateDefaultRoute *string                       `xml:"create-default-route,omitempty"`
	DefaultRouteMetric *int64                        `xml:"default-route-metric,omitempty"`
	Enable             *string                       `xml:"enable,omitempty"`
	Passive            *pppoePassiveXml_11_0_2       `xml:"passive,omitempty"`
	Password           *string                       `xml:"password,omitempty"`
	Service            *string                       `xml:"service,omitempty"`
	StaticAddress      *pppoeStaticAddressXml_11_0_2 `xml:"static-address,omitempty"`
	Username           *string                       `xml:"username,omitempty"`
	Misc               []generic.Xml                 `xml:",any"`
}
type pppoePassiveXml_11_0_2 struct {
	Enable *string       `xml:"enable,omitempty"`
	Misc   []generic.Xml `xml:",any"`
}
type pppoeStaticAddressXml_11_0_2 struct {
	Ip   *string       `xml:"ip,omitempty"`
	Misc []generic.Xml `xml:",any"`
}
...
func (o *pppoeXml) MarshalFromObject(s Pppoe) {
...
func (o pppoeXml) UnmarshalToObject() (*Pppoe, error) {
	var passiveVal *PppoePassive
	if o.Passive != nil {
	...
	var staticAddressVal *PppoeStaticAddress
...
func (o *pppoePassiveXml) MarshalFromObject(s PppoePassive) {
	o.Enable = util.YesNo(s.Enable, nil)
	o.Misc = s.Misc
}

func (o pppoePassiveXml) UnmarshalToObject() (*PppoePassive, error) {
...
func (o *pppoeStaticAddressXml) MarshalFromObject(s PppoeStaticAddress) {
	o.Ip = s.Ip
	o.Misc = s.Misc
}

func (o pppoeStaticAddressXml) UnmarshalToObject() (*PppoeStaticAddress, error) {

	result := &PppoeStaticAddress{
		Ip:   o.Ip,
		Misc: o.Misc,
	}
	return result, nil
...
func (o *pppoeXml_11_0_2) MarshalFromObject(s Pppoe) {
	o.AccessConcentrator = s.AccessConcentrator
	o.Authentication = s.Authentication
	o.CreateDefaultRoute = util.YesNo(s.CreateDefaultRoute, nil)
	o.DefaultRouteMetric = s.DefaultRouteMetric
	o.Enable = util.YesNo(s.Enable, nil)
	if s.Passive != nil {
		var obj pppoePassiveXml_11_0_2
		obj.MarshalFromObject(*s.Passive)
		o.Passive = &obj
	}
	o.Password = s.Password
	o.Service = s.Service
	if s.StaticAddress != nil {
		var obj pppoeStaticAddressXml_11_0_2
		obj.MarshalFromObject(*s.StaticAddress)
		o.StaticAddress = &obj
	}
	o.Username = s.Username
...
func (o pppoeXml_11_0_2) UnmarshalToObject() (*Pppoe, error) {
	var passiveVal *PppoePassive
	if o.Passive != nil {
		obj, err := o.Passive.UnmarshalToObject()
		if err != nil {
...
func (o *pppoePassiveXml_11_0_2) MarshalFromObject(s PppoePassive) {
	o.Enable = util.YesNo(s.Enable, nil)
	o.Misc = s.Misc
}

func (o pppoePassiveXml_11_0_2) UnmarshalToObject() (*PppoePassive, error) {
...
func (o *pppoeStaticAddressXml_11_0_2) MarshalFromObject(s PppoeStaticAddress) {
	o.Ip = s.Ip
	o.Misc = s.Misc
}

func (o pppoeStaticAddressXml_11_0_2) UnmarshalToObject() (*PppoeStaticAddress, error) {
...
func (o *Pppoe) matches(other *Pppoe) bool {
	if o == nil && other == nil {
		return true
	}
...
func (o *PppoePassive) matches(other *PppoePassive) bool {
	if o == nil && other == nil {
		return true
	}
...
func (o *PppoeStaticAddress) matches(other *PppoeStaticAddress) bool {
	if o == nil && other == nil {
		return true
	}
