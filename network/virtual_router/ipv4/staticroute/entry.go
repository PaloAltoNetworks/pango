...
var (
	suffix = []string{"network", "virtual-router", "$parent", "routing-table", "ip", "static-route", "$name"}
)
...
func (o *routeTableXml) MarshalFromObject(s RouteTable) {
	if s.Both != nil {
		var obj routeTableBothXml
		obj.MarshalFromObject(*s.Both)
		o.Both = &obj
	}
	if s.Multicast != nil {
		var obj routeTableMulticastXml
...
func (o routeTableXml) UnmarshalToObject() (*RouteTable, error) {
	...
	var multicastVal *RouteTableMulticast
	if o.Multicast != nil {
...
func (o *RouteTableBoth) matches(other *RouteTableBoth) bool {
	if o == nil && other == nil {
		return true
	}
...
func (o *RouteTableMulticast) matches(other *RouteTableMulticast) bool {
	if o == nil && other == nil {
		return true
	}
